...
router.get("/movies",getMovieById);// sends req to get movies based on id 

router.post("/movies",authMiddleware,roleMiddleware,("admin"),addMovie);//sends req to addmovie
router.put("/movies/:id",authMiddleware,roleMiddleware,("admin"),updateMovie);// sends req to update a movie
